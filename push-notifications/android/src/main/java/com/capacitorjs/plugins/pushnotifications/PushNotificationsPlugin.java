...
public class PushNotificationsPlugin extends Plugin {
    ...
    protected void handleOnNewIntent(Intent data) {
      ...
      Bundle bundle = data.getBundleExtra("notification");
      Log.d("myMessage0000: ", String.valueOf(data));
      JSONObject notificationData = new JSONObject();
      if (bundle != null) {
        try {
//          Log.d("myMessage22: ", String.valueOf(data));
          Log.d("myMessage22: ", String.valueOf(bundle.get("notification")));

          JSONObject jsonObj = new JSONObject(bundle.get("notification").toString());

          notificationData = new JSONObject(jsonObj.get("data").toString());
        ...
        if (bundle != null && bundle.containsKey("notification")) {
            ...
            notificationJson.put("data", notificationData);
            JSObject actionJson = new JSObject();
           // actionJson.put("actionId", "tap");
//          Log.d("myMessage22: ", String.valueOf(actionJson));
          Log.d("myMessage23: ", String.valueOf(notificationJson));
